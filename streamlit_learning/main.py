...
def show_dev_info():
    ...
    with st.container(height=300, border=True):
            dev_img = r"\streamlit_learning\images\ADAM'S_IMAGE.png"
...
def show_creator_info():
    with st.container(height=300, border=True, ):
        creator_img = r"\streamlit_learning\images\FARIDA'S_IMAGE.png"
...
# bracelets images
def load_images():
    bracelet1 = PIL.Image.open(r"streamlit_learning\images\bracelet (1).jpg")
    bracelet2 = PIL.Image.open(r"streamlit_learning\images\bracelet (2).jpg")
    bracelet3 = PIL.Image.open(r"streamlit_learning\images\bracelet (3).jpg")
    bracelet4 = PIL.Image.open(r"streamlit_learning\images\bracelet (4).jpg")
    bracelet5 = PIL.Image.open(r"streamlit_learning\images\bracelet (5).jpg")
    bracelet6 = PIL.Image.open(r"streamlit_learning\images\bracelet (6).jpg")
    bracelet7 = PIL.Image.open(r"streamlit_learning\images\bracelet (7).jpg")
    bracelet8 = PIL.Image.open(r"streamlit_learning\images\bracelet (8).jpg")
    bracelet9 = PIL.Image.open(r"streamlit_learning\images\bracelet (9).jpg")
    bracelet10 =PIL.Image.open(r"streamlit_learning\images\bracelet (10).jpg")
    necklace1 = PIL.Image.open(r"streamlit_learning\images\necklace (1).jpg")
    necklace2 = PIL.Image.open(r"streamlit_learning\images\necklace (2).jpg")
    necklace3 = PIL.Image.open(r"streamlit_learning\images\necklace (3).jpg")
    necklace4 = PIL.Image.open(r"streamlit_learning\images\necklace (4).jpg")
    necklace5 = PIL.Image.open(r"streamlit_learning\images\necklace (5).jpg")
    necklace6 = PIL.Image.open(r"streamlit_learning\images\necklace (6).jpg")
    necklace7 = PIL.Image.open(r"streamlit_learning\images\necklace (7).jpg")
    ring18 =    PIL.Image.open(r"streamlit_learning\images\ring (1).jpg")

# Loading Images
images_paths = [
PIL.Image.open(r"streamlit_learning\images\bracelet (1).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (2).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (3).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (4).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (5).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (6).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (7).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (8).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (9).jpg"),
PIL.Image.open(r"streamlit_learning\images\bracelet (10).jpg"),
PIL.Image.open(r"streamlit_learning\images\necklace (1).jpg"),
PIL.Image.open(r"streamlit_learning\images\necklace (2).jpg"),
PIL.Image.open(r"streamlit_learning\images\necklace (3).jpg"),
PIL.Image.open(r"streamlit_learning\images\necklace (4).jpg"),
PIL.Image.open(r"streamlit_learning\images\necklace (5).jpg"),
PIL.Image.open(r"streamlit_learning\images\necklace (6).jpg"),
PIL.Image.open(r"streamlit_learning\images\necklace (7).jpg"),
PIL.Image.open(r"streamlit_learning\images\ring (1).jpg")
]
